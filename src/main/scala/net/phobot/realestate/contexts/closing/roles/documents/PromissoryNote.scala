...
case class PromissoryNote[RoleKeyType](val key: PromissoryNoteKey, var inThePossessionOf: RoleKey[RoleKeyType]) extends ClosingDocument {
...
case class PromissoryNoteKey(private val myId: Long) extends RoleKey[Long] { def id = myId }
