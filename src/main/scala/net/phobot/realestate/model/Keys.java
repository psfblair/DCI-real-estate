...
public class Keys {
	...
	private static class ForeignKeys0 extends org.jooq.impl.AbstractKeys {
		...
		public static final org.jooq.ForeignKey<net.phobot.realestate.model.tables.records.ActorsrepresentativesRecord, net.phobot.realestate.model.tables.records.ActorsRecord> CONSTRAINT_5A = createForeignKey(net.phobot.realestate.model.Keys.CONSTRAINT_3, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES.ACTOR_ID);
		public static final org.jooq.ForeignKey<net.phobot.realestate.model.tables.records.ActorsrepresentativesRecord, net.phobot.realestate.model.tables.records.RepresentativesRecord> CONSTRAINT_5A7 = createForeignKey(net.phobot.realestate.model.Keys.CONSTRAINT_6A, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES.REPRESENTATIVE_ID);
		public static final org.jooq.ForeignKey<net.phobot.realestate.model.tables.records.ActorsrepresentativesRecord, net.phobot.realestate.model.tables.records.PurchasesRecord> CONSTRAINT_5 = createForeignKey(net.phobot.realestate.model.Keys.CONSTRAINT_3B, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES, net.phobot.realestate.model.tables.Actorsrepresentatives.ACTORSREPRESENTATIVES.PURCHASE_ID);
